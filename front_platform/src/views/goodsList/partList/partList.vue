...
<!--配件列表 -->
  <div class="partlist">
      ...
      <Carousel arrow="always" trigger="hover" loop radius-dot>
        <CarouselItem>
          <div class="demo-carousel">
            <img src="@/static/image/banner2.jpg" alt>
          </div>
        </CarouselItem>
        <CarouselItem>
          <div class="demo-carousel">
            <img src="@/static/image/banner4.jpg" alt>
          </div>
        </CarouselItem>
        <CarouselItem>
          <div class="demo-carousel">
            <img src="@/static/image/banner6.jpg" alt>
          </div>
        </CarouselItem>
        <CarouselItem>
          <div class="demo-carousel">
            <img src="@/static/image/banner3.jpg" alt>
          </div>
        </CarouselItem>
      </Carousel>
    </div>
    <main>
      <div class="layout">
        <h1 class="title">
          <span id="title-category">配件</span>
        ...
        <ul class="goodlist">
          <li class="goods-box" v-for="(item,index) in partList" :key="index">
            <span class="box-img">
              ...
              <span class="product-sign blue">促销</span>
            </span>
          </li>
        </ul>
      </div>
...
<script>
import {getpartlist} from '@/api/goods'
export default {
  name: "partlist",
  data() {
    return {
