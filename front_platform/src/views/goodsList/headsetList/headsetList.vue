...
<!--耳机列表 -->
  <div class="headsetList">
    ...
    <main>
      <div class="layout">
        <h1 class="title">
          <span id="title-category">声学</span>
        ...
        <ul class="goodlist">
          <li class="goods-box" v-for="(item,index) in headsetList" :key="index">
            <span class="box-img">
...
<script>
import {getheadsetlist} from '@/api/goods'
export default {
  name: "headsetList",
  data() {
    return {
