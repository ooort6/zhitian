...
<!--生活周边 -->
  <div class="arroundlist">
    ...
    <main>
      <div class="layout">
        <h1 class="title">
          <span id="title-category">生活周边</span>
        ...
        <ul class="goodlist">
          <li class="goods-box" v-for="(item,index) in arroundList" :key="index" @click="arroundDetails(item)">
            <span class="box-img">
...
<script>
import {getarroundlist} from '@/api/goods'
export default {
  name: "partlist",
  data() {
    return {
