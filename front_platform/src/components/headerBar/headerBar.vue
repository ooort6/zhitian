<template>
    <div class="headerBar">
        <div class="layout">
            ...
            <div class="logo"><img @click="$router.push({name: 'home'})" src="@/static/image/4.png" alt="" ></div>
             <!-- <div class="zhuce"> -->
            ...
            <div class="nav">
               <Menu mode="horizontal" :theme="'light'" :active-name="$route.name">
                    <MenuItem class="nav-item" name="phoneList" :to="{name:'phoneList'}" >
                        <!-- <Icon type="ios-paper" /> -->
                        首页
                    </MenuItem>
                    <MenuItem class="nav-item" name="headsetList" :to="{name:'headsetList'}">
                        <!-- <Icon type="ios-stats" /> -->
                        产品与解决方案
                    </MenuItem>
                    <MenuItem class="nav-item" name="partList" :to="{name:'partList'}">
                        <!-- <Icon type="ios-people" /> -->
                        成功案例
                    </MenuItem>
                    <MenuItem class="nav-item" name="lifeRoundList" :to="{name:'lifeRoundList'}">
                        <!-- <Icon type="ios-people" /> -->
                        合作发展
                    </MenuItem>
                    <MenuItem class="nav-item" name="5">
                        <!-- <Icon type="ios-people" /> -->
                        关于我们
                    </MenuItem>
                    <MenuItem class="nav-item" name="6">
                        <!-- <Icon type="ios-people" /> -->
                        资料下载
                    </MenuItem>
